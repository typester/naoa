...
<p>
The other way is to only write a Mojo::Template file, which acts much like PHP.  <a href="mojo">this page</a> is a good example (<a href="http://coderepos.org/share/browser/lang/perl/NanoA/trunk/example/mojo.mt">source code</a>).
</p>
<hr />
<p>
